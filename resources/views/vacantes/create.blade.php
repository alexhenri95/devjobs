...
@section('content')
	...
	<form action="{{route('vacantes.store')}}" method="POST" class="max-w-lg mx-auto my-10">
		...
		<button type="submit" class="bg-teal-500 w-full hover:bg-teal-600 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase font-bold text-sm cursor-pointer">Publicar vacante</button>
