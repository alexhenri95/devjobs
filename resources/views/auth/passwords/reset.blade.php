    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form method="POST" action="{{ route('password.update') }}" class="py-8 px-5" novalidate="">
                    @csrf
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-2 bg-gray-300 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ $email ?? old('email') }}"  autocomplete="email" autofocus>
