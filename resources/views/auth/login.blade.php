    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form method="POST" action="{{ route('login') }}" class="py-8 px-5" novalidate="">
                    @csrf
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-2 bg-gray-300 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password"  autocomplete="current-password">
                    ...
                    <div class="flex flex-wrap ">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm text-gray-500 mt-4 text-center w-full" href="{{ route('password.request') }}">
